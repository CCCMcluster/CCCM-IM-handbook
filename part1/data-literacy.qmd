...
![A shared understanding of terms is important for engagement around data](./images/idontthinkitmeanswhatyouthinkitmeans.jpg){width=70% }
...
![Examples of data as tables, a relational database, and as JSON from an travel distance API](./images/formats.png){.column-page-right width=70% }
...
![Types of data and how they relate](./images/typesofdata.png){.column-page-right width=70% }
...
### Use Excel for numerical data
![Tatsuo Horiuchi uses Excel to paint beautiful Japanese lanscapes. Don't follow Tatsuo](./images/paintingwithexcel.jpg){.column-page-right width=70% }
...
### Save often, use versioning, and name files sensibly

![Click save!](./images/saveoften.png){.column-page-right width=70% }
...
### Check for existing data, communicate  
...
### Spreadsheets - only one piece of information per cell
...
### Record data at a granular level and aggregate up  
...
### Learn VLOOKUP and Index Match  
![vlookup](./images/vlookup.png)

### Don't merge cells in a spreadsheet  
...
### Keep data types and names consistent in columns
...
### Keep all similar data in one sheet
