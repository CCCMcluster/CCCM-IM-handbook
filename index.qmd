...
::: {.callout-note}
This handbook is also available to download in pdf and epub formats (see top left). To use the handbook as an offline mobile app, click "Add to home screen" on Chrome and visit the pages you wish to cache/save.
:::
...
![Towards evidence-based decision making](part1/images/spirits.jpg){width=70% }
...
- Guidance materials developed at the global-level from inter-agency platforms including the Global Information Management Working Group and from other Clusters.
